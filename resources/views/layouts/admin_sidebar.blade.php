	...
	<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto " id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="{{route('system.home')}}" class="brand-logo">
							<img alt="Logo" class="img-fluid ml-5"  style="width: 75px; height :60px" src="{{asset('uploads/logo.svg')}}" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
                                ...
                                {{-- <li class="menu-item  menu-item-active" aria-haspopup="true">
                                    ...
                                    <li class="menu-item menu-item-submenu
                                        ...
                                        <a href="{{route('system.department')}}" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{__('system.departments')}}</span>
                                        </a>
                                ...
                                {{-- start employee --}}
                                    <li class="menu-item menu-item-submenu
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">{{__('system.employees')}}</span>
                                        </a>
                                </li>
                                {{-- end employee --}}
                                    ...
                                    <li class="menu-item menu-item-submenu
                                            ...
                                            aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="javascript:;" class="menu-link menu-toggle">
                                                    ...
                                                    <span class="menu-text">{{__('system.tasks')}}</span>
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('task_statuses.index')}}" class="menu-link">
                                                                <i class="menu-bullet menu-bullet-dot">
                                                                    <span></span>
                                                                </i>
                                                                <span class="menu-text">{{__('system.status')}}</span>
                                                            </a>
                                                        </li>
