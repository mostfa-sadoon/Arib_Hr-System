    ...
    <!DOCTYPE html>
    <!--
    Template Name: Metronic - Bootstrap 4 HTML, React, Angular 11 & VueJS system Dashboard Theme
    Author: KeenThemes
                    ...
                    <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                        ...
                        <div class="d-flex flex-column-fluid flex-center">
                            ...
                            <div class="login-form login-signin">
                                <!--begin::Form-->
                                <form  action="{{route('system.login.submit')}}" method="post" class="form">
                                    @csrf
                                    <!--begin::Title-->
                                    <div class="pb-13 pt-lg-0 pt-5">
                                        <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">{{trans('system.welcome_to_arib')}}</h3>
                                    </div>
                                    <!--begin::Title-->
                                    <!--begin::Form group-->
