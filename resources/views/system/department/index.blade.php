                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <a class="delete_department" data-id="{{$row->id}}" data-toggle="modal" data-target="#deleteDepartment">
                    ...
                    <div class="modal-dialog modal-xl bd-example-modal-xl" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('system.department.update')}}">
                                ...
                                <div class="modal-body" id="department_detailes">
                ...
                <div class="modal fade outer-repeater" id="AddDepartment" tabindex="-1" role="dialog" aria-labelledby="AddDepartment" aria-hidden="true">
                    <div class="modal-dialog modal-xl bd-example-modal-xl" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('system.department.store')}}">
                                @csrf
            ...
            <!-- start delete department modal -->
                <div class="modal fade" id="deleteDepartment" tabindex="-1" role="dialog" aria-labelledby="deleteDepartment" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{route('system.department.delete')}}" method="post">
                            @csrf
...
<script>
    ...
    $('#datatable').on('click','.delete_department',function (){
    ...
    $('#datatable').on('click','.edit',function (){
         ...
         $.ajax({
                ...
                success: function (response) {
                    $('#department_detailes').html(response);
                },
