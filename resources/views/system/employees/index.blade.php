            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label"> {{__('system.employees')}}</h3>
                    </div>
                                 ...
                                 <td nowrap="nowrap">
                                    ...
                                    @if (Auth::user()->is_manager==true)
                                        ...
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
                                            ...
                                            <a href="{{route('employees.edit',$row->id)}}" class="edit">
                                    ...
                                    <a href="" class="delete" data-id="{{$row->id}}" data-toggle="modal" data-target="#deleteTask">
                ...
                <div class="modal fade outer-repeater" id="AddDepartment" tabindex="-1" role="dialog" aria-labelledby="AddDepartment" aria-hidden="true">
                    <div class="modal-dialog modal-xl bd-example-modal-xl" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <h2 class="modal-title bold"  id="exampleModalLabel">{{__('system.add_employee')}}</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                                ...
                                                <div class="image-input-wrapper" style="background-image: url({{asset('/uploads/default-profile-picture.jpg')}})" ></div>
                                        ...
                                        <div class="col-6">
                                            <div>
                                                ...
                                                <input class="form-control" name="first_name"   value="" type="text" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div>
                                                ...
                                                <input class="form-control" name="last_name"   value="" type="text" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div>
                                                ...
                                                <input class="form-control" name="salary"   value="" type="text" required>
                                            </div>
                                        </div>
