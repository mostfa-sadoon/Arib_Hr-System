...
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label"> {{__('system.departments')}}</h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>{{__('system.add_department')}}</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-checkable" id="datatable">
                        ...
                        <tbody>
                            @foreach ($TaskStatuses as $key=>$row)
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                        ...
                                        <a href="{{route('task_statuses.destroy',$row->id)}}" class="edit"  data-id="{{$row->id}}"  data-toggle="modal" data-target="#EditTaskStatus" >
                                    ...
                                    <a class="delete_task_status" data-id="{{$row->id}}"  >
            ...
            {{--begain::edit TaskStatus model --}}
                <div class="modal fade outer-repeater" id="EditTaskStatus" tabindex="-1" role="dialog" aria-labelledby="EditTaskStatus" aria-hidden="true">
                    <div class="modal-dialog modal-xl bd-example-modal-xl" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" action="{{route('task_statuses.update',0)}}">
                                @method('PUT')
                                @csrf
                                <div class="modal-body" id="task_status_detailes">
            ...
            {{--end::edit TaskStatus model --}}


            {{--begain::add TaskStatus model --}}
                <div class="modal fade outer-repeater" id="AddDepartment" tabindex="-1" role="dialog" aria-labelledby="AddDepartment" aria-hidden="true">
                    <div class="modal-dialog modal-xl bd-example-modal-xl" role="document">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                            <h2 class="modal-title bold"  id="exampleModalLabel">{{__('system.add_status')}}</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            </div>
            ...
            {{--end::add TaskStatus model --}}



            <!-- start delete TaskStatus modal -->
                <div class="modal fade" id="deleteTaskStatus" tabindex="-1" role="dialog" aria-labelledby="deleteTaskStatus" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{route('task_statuses.delete')}}" method="post">
                          @csrf
...
<script>
    ...
    $('#datatable').on('click','.delete_task_status',function (){
         var id=$(this).attr("data-id");
        $('#deleteTaskStatus').modal('show');
        $('#id').val(id);
    ...
    $('#datatable').on('click','.edit',function (){
         ...
         $.ajax({
                url:"/task_statuses/"+id+'/edit',
                type:"GET", //send it through get method
                success: function (response) {
                    $('#task_status_detailes').html(response);
                },
                error: function(response) {

                }
         });
        $('#EditTaskStatus').modal('show');
    });
</script>
